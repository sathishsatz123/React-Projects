...
const colorList = ['yellow', 'green', 'orange', 'brown', 'blue', 'white']
...
class Password extends Component {
  ...
  addContent = event => {
    ...
    const classValue = colorList[Math.floor(Math.random() * 6)]
  ...
  deleteItem = id => {
    ...
    const newsList = latestList.filter(eachValue => eachValue.id !== id)
    const caseOf = newsList.length !== 0
    this.setState({latestList: newsList, isTrue: caseOf})
  }
